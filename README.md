...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/statannot-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12336&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/statannot-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `statannot` can be installed with:

```
conda install statannot
```

It is possible to list all of the versions of `statannot` available on your platform with:
